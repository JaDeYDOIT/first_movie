...
<script src="https://kit.fontawesome.com/cbc1642524.js"
					...
					<ul class="login_wrap">
						<c:choose>
							<c:when test="${sessionScope.s_id eq 'guest'}">
								...
								<li id="loginhid"><img src="/images/header_icon/login.png"
									alt="" onclick="location.href='/member/login.do'"><a
									href="/member/login.do">로그인</a></li>
								<li id="hiddenNewMember"><img
									src="/images/header_icon/newmember.png" alt=""
									onclick="location.href='/member/member.do'"><a
									href="/member/member.do">회원가입</a></li>
							</c:when>
							<c:when
								test="${not empty sessionScope.s_id && sessionScope.s_id ne 'guest'}">
								<style>
#hiddenNewMember {
	display: none;
}
</style>
								<li><img src="/images/header_icon/logout.png" alt=""
									onclick="kakaoLogout()"><a href="/member/logout.do">로그아웃</a></li>
							</c:when>
							<c:otherwise>
								<%
								// HttpSession 객체 가져오기
...
<<<<<<< HEAD
						...
						<li><img src="/images/header_icon/mypage.png" alt=""><a
							href="/member/memberInfo.do">my page</a></li>
						<li><img src="/images/header_icon/csc.png" alt=""
							onclick="location.href='/customer/notice.do?notice_kind=0'"><a
							href="/customer/notice.do?notice_kind=0">고객센터</a></li>
					</ul>
				</div>
				<div class="nav_bottom">
					<ul class="nav_wrap">
						...
						<li><a
							href="/theater/branchlist.do?region_id=region_001&branch_id=1">극장</a></li>
						<li><a href="/ticketing/schedule" class="ticketing_menu"
							style="color: rgb(0, 128, 255);">예매</a></li>
